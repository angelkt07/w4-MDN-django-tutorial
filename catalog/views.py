...
def renew_book_librarian(request, pk):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            return HttpReesponseRedirect(reverse('all-borrowed'))
...
@permission_required('author.can_delete_author')
def delete_author(request, pk):
    """View function for renewing a specific Author by librarian."""
